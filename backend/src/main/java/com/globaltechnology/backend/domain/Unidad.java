...
public class Unidad extends Auditable {
  ...
  // Nota: si el modelo.trackeaImei = true => debés validar en servicio que IMEI no sea null.
  @Column(name = "imei", unique = true, length = 20)
  private String imei; // nullable si no aplica

  @Column(name = "numero_serie", length = 50)
  private String numeroSerie; // nullable

  @Column(name = "bateria_condicion_pct")
  private Integer bateriaCondicionPct; // nullable; 0..100

  @Column(name = "costo_unitario")
  private Long costoUnitario; // centavos (sugerencia) o usar BigDecimal
