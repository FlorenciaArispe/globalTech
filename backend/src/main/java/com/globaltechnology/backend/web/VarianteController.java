...
public class VarianteController {
  ...
  public VarianteDTO create(@Valid @RequestBody VarianteCreateDTO dto){ return service.create(dto); }

  @PutMapping("/{id}")
  public VarianteDTO update(@PathVariable Long id, @Valid @RequestBody VarianteUpdateDTO dto){ return service.update(id, dto); }

  @DeleteMapping("/{id}") @ResponseStatus(HttpStatus.NO_CONTENT)
  public void delete(@PathVariable Long id){ service.delete(id); }

  @GetMapping("/{id}/stock") public VarianteStockDTO stock(@PathVariable Long id){ return service.stock(id); }
