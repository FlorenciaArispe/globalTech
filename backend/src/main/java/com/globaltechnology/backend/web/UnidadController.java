...
public class UnidadController {
  ...
  @GetMapping("/{id}") public UnidadDTO get(@PathVariable Long id){ return service.get(id); }
  ...
  public List<UnidadDTO> porVariante(@PathVariable Long varianteId){ return service.listByVariante(varianteId); }
}
